...
def get_numbers_ticket(min, max, quantity) :
 ...
 # checking if min and max values are correct by requirements
    if min < 1 or max > 1000:
        return []

# checking if quantity value is correct (difference between min and max +1 will include min and max values than should be exluded , and min qt is 1)
...
print(get_numbers_ticket(6, 444, 134))
